...
var execNext = function() {
	...
	if((argv.s.toString().substring(5) == '1' && nrcs[index].nrc.toString().substring(0,1) != '1') ||
		(argv.s.toString().substring(5) == '5' && nrcs[index].nrc.toString().substring(0,1) != '5') ||
		(argv.s.toString().substring(5) == '9' && nrcs[index].nrc.toString().substring(0,1) != '8')) {
		index++;
		execNext();
		return;
	}
